...
dd if=/dev/urandom of=${SRCFILE} bs=1K count=100 >/dev/null 2>&1

echo "BLOB FILE TEST"

dd if=${SRCFILE} of=${TEST_FILE1} bs=1K seek=3 count=13 >/dev/null 2>&1
dd if=${SRCFILE} of=${TEST_FILE2} bs=1K seek=3 count=13 >/dev/null 2>&1
